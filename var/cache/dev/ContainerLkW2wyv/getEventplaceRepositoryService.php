 ...
 */
class getEventplaceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EventplaceRepository' shared autowired service.
     *
     * @return \App\Repository\EventplaceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EventplaceRepository.php';

        return $container->privates['App\\Repository\\EventplaceRepository'] = new \App\Repository\EventplaceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
